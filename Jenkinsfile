  ...
  stages {
    ...
    stage("Build") {
      steps {
        powershell '''
          ...
          dotnet build --output FOR_RELEASE/GameData/UmbraSpaceIndustries/ART --configuration $env:BUILD_CONFIG `
            --verbosity detailed /p:ReferencePath="$ReferencePath" ./Source/DynamicTanks/DynamicTanks.csproj
        '''
      }
    }
    ...
    stage("Package artifacts") {
      steps {
        ...
        '''
        script {
          env.ARCHIVE_FILENAME = "ART_${env.GITVERSION_SEMVER}.zip"
